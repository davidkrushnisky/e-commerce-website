...
namespace ECommercePlateform.Controllers
{
    public class OrdersController : Controller
    {
        ...
        /*
        public Collection<Product> CreateProductCollection()
        {
        ...
        /*public async Task<IActionResult> EditProductList(int id, [Bind("OrderId,UserId,TotalPrice,OrderDate")] Collection<Product> products)
        {
            if (products.Count == 0)
            {
