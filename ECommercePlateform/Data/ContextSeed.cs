...
namespace ECommercePlateform.Data
{
    public class ContextSeed
    {
        ...
        public static async Task SeedDBAsync(ApplicationDbContext context, UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager, string defaultPw)
        {
            //Seed Default Admin
            ...
            if (userManager.Users.All(u => u.Id != defaultClient.Id))
            {
                ...
                if (user == null)
                {
                    ...
                    await userManager.AddToRoleAsync(defaultClient, Enums.Roles.Admin.ToString());
                }
            ...
            if (!context.Products.Any())
            {
                ...
                context.Products.AddRange(
                    new Product
                    {
                        ...
                        Category = context.Categories.FirstOrDefault(c => c.CategoryId == 1)
                    },
                    new Product
                    {
                        Name = "Bose 700",
                    ...
                    new Product
                    {
                        ...
                        Category = context.Categories.FirstOrDefault(c => c.CategoryId == 2)
                    },
                    new Product
                    {
                    ...
                    new Product
                    {
                        ...
                        Category = context.Categories.FirstOrDefault(c => c.CategoryId == 3)
                    },
                    new Product
                    {
