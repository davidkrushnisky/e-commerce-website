...
namespace ECommercePlateform.Data
{
    public class ContextSeed
    {
        ...
        public static async Task SeedDBAsync(ApplicationDbContext context)
        {
            ...
            if (!context.Categories.Any())
            {
                context.Categories.AddRange(
                    new Category
                    {
                        ...
                        Description = "",
                        Picture = GetImage("wwwroot/media/Headphones/CategoryImage.jpg")
                    },
                    new Category
                    {
                        CategoryName = "Keyboards",
                        Description = "",
                        Picture = GetImage("wwwroot/media/Keyboards/CategoryImage.jpg")
                    },
                    new Category
                    {
                        CategoryName = "Monitors",
                        Description = "",
                        Picture = GetImage("wwwroot/media/Monitors/CategoryImage.jpg")
                    }
                );
                context.SaveChanges();
            }
            ...
            {
                //Headphones
                byte[] image1 = GetImage("wwwroot/media/Headphones/Apple_AirPods_Pro.jpeg");
                byte[] image2 = GetImage("wwwroot/media/Headphones/Bose_700.jpg");
                byte[] image3 = GetImage("wwwroot/media/Headphones/Bose_QuietComfort_45.jpg");
                byte[] image4 = GetImage("wwwroot/media/Headphones/Bowers_&_Wilkins_Px7_S2.jpg");
                byte[] image5 = GetImage("wwwroot/media/Headphones/Grado_GT220.jpg");
                byte[] image6 = GetImage("wwwroot/media/Headphones/Master_&_Dynamic_MW08.jpg");
                byte[] image7 = GetImage("wwwroot/media/Headphones/Sennheiser_Momentum_4_Wireless.jpg");
                byte[] image8 = GetImage("wwwroot/media/Headphones/Technics_EAH-A800.jpg");
                byte[] image9 = GetImage("wwwroot/media/Headphones/Technics_EAH-AZ60.jpg");
                byte[] image10 = GetImage("wwwroot/media/Headphones/Sony_WH-1000XM5.jpg");

                //Keyboards
                byte[] image1k = GetImage("wwwroot/media/Keyboards/Apple_Magic_Keyboard.jpg");
                byte[] image2k = GetImage("wwwroot/media/Keyboards/Cherry_Stream_Desktop_Keyboard.jpg");
                byte[] image3k = GetImage("wwwroot/media/Keyboards/Das_Keyboard_4_Professional.jpg");
                byte[] image4k = GetImage("wwwroot/media/Keyboards/Logitech_Craft.jpg");
                byte[] image5k = GetImage("wwwroot/media/Keyboards/Logitech_MX_Keys_Mini.jpg");
                byte[] image6k = GetImage("wwwroot/media/Keyboards/Logitech_Mx_Mechanical.jpg");
                byte[] image7k = GetImage("wwwroot/media/Keyboards/Razer_Deathstalker_V2_Pro.jpg");
                byte[] image8k = GetImage("wwwroot/media/Keyboards/Razer_Huntsman_V2_Analog.jpg");
                byte[] image9k = GetImage("wwwroot/media/Keyboards/Razer_Pro_Type_Ultra.jpg");
                byte[] image10k = GetImage("wwwroot/media/Keyboards/Unicomp_New_Model_M.jpg");


                //Monitors
                byte[] image1m = GetImage("wwwroot/media/Monitors/Acer_Predator_X38.jpg");
                byte[] image2m = GetImage("wwwroot/media/Monitors/Alienware_34_QD-OLED_(AW3423DW).jpg");
                byte[] image3m = GetImage("wwwroot/media/Monitors/Dell_S2722DGM.jpg");
                byte[] image4m = GetImage("wwwroot/media/Monitors/Dell_S3222DGM.jpg");
                byte[] image5m = GetImage("wwwroot/media/Monitors/Gigabyte_M28U.png");
                byte[] image6m = GetImage("wwwroot/media/Monitors/GigabyteG27Q.jpg");
                byte[] image7m = GetImage("wwwroot/media/Monitors/LG_27GN950-B.jpg");
                byte[] image8m = GetImage("wwwroot/media/Monitors/MSI_Oculux_NXG253R.jpg");
                byte[] image9m = GetImage("wwwroot/media/Monitors/Samsung_Odyssey_Neo_G9.jpg");
                byte[] image10m = GetImage("wwwroot/media/Monitors/Pixio_PX277_Prime.png");
